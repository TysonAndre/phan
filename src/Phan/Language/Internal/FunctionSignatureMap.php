...
'ldap_control_paged_result_response' => ['bool', 'link_identifier'=>'resource', 'result_identifier'=>'resource', '&cookie'=>'string', '&estimated'=>'int'],
...
'ldap_get_option' => ['bool', 'link_identifier'=>'resource', 'option'=>'int', '&retval'=>''],
...
'Memcached::decrement' => ['int', 'key'=>'string', 'offset='=>'int', 'initial_value='=>'int', 'expiry='=>'int'],
...
'Memcached::increment' => ['int', 'key'=>'string', 'offset='=>'int', 'initial_value='=>'int', 'expiry='=>'int'],
...
'Redis::save' => ['bool'],
'Redis::scan' => ['string[]|false', 'iterator'=>'?int', 'pattern='=>'?string', 'count='=>'?int'],
...
'stream_select' => ['int|false', '&read_streams'=>'array', '&write_streams'=>'?array', '&except_streams'=>'?array', 'tv_sec'=>'?int', 'tv_usec='=>'?int'],

...
class FutureUnionType
{
    ...
    public function get()
    {
        $ret5902c6f6c8af4 = UnionType::fromNode($this->context, $this->code_base, $this->node, false);
        if (!$ret5902c6f6c8af4 instanceof UnionType) {
            throw new \InvalidArgumentException("Argument returned must be of the type UnionType, " . (gettype($ret5902c6f6c8af4) == "object" ? get_class($ret5902c6f6c8af4) : gettype($ret5902c6f6c8af4)) . " given");
        }
        return $ret5902c6f6c8af4;
    }
}
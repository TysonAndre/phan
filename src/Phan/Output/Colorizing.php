...
class Colorizing
{
    ...
    const default_color_for_template = ['CLASS' => 'green', 'CONST' => 'light_red', 'COUNT' => 'light_magenta', 'FILE' => 'light_cyan', 'FUNCTIONLIKE' => 'light_yellow', 'FUNCTION' => 'light_yellow', 'INDEX' => 'light_magenta', 'INTERFACE' => 'green', 'ISSUETYPE' => 'light_yellow', 'ISSUETYPE_CRITICAL' => 'red', 'ISSUETYPE_NORMAL' => 'light_red', 'LINE' => 'light_gray', 'METHOD' => 'light_yellow', 'PARAMETER' => 'cyan', 'PROPERTY' => 'cyan', 'TYPE' => 'light_gray', 'TRAIT' => 'green', 'VARIABLE' => 'light_cyan'];
    /**
     ...
     */
    public static function colorizeTemplate($template, array $template_parameters)
    {
        $i = 0;
        /** @param string[] $matches */
        return preg_replace_callback('/{([A-Z_]+)}|%[sdf]/', function (array $matches) use($template, $template_parameters, &$i) {
            $j = $i++;
     ...
     */
    public static function colorizeField($template_type, $arg)
    {
        $fmt_directive = call_user_func(function ($v1, $v2) {
            return isset($v1) ? $v1 : $v2;
        }, @Issue::uncolored_format_string_for_template[$template_type], @null);
        ...
        $color_code = call_user_func(function ($v1, $v2) {
            return isset($v1) ? $v1 : $v2;
        }, @self::styles[$color], @null);
        if ($color_code === null) {
     ...
     */
    private static function colorForTemplate($template_type)
    {
        ...
        return call_user_func(function ($v1, $v2) {
            return isset($v1) ? $v1 : $v2;
        }, @self::$color_scheme[$template_type], @null);
    }
    /**
    ...
    private static function initColorScheme()
    {
        ...
        foreach (call_user_func(function ($v1, $v2) {
            return isset($v1) ? $v1 : $v2;
        }, @Config::get()->color_scheme, @[]) as $template_type => $color_name) {

...
class ParallelChildCollector implements IssueCollectorInterface
{
    ...
    {
        $ret5902c6fe18a11 = [];
        if (!is_array($ret5902c6fe18a11)) {
            throw new \InvalidArgumentException("Argument returned must be of the type array, " . gettype($ret5902c6fe18a11) . " given");
        }
        return $ret5902c6fe18a11;
    }
    /**

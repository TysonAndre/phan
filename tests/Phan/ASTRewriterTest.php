...
class ASTRewriterTest extends AbstractPhanFileTest
{
    ...
    public function getTestFiles()
    {
        ...
        return array_map(function (array $values) {
            ...
            $ret5934ad3e7dde4 = [$values[0][0], $values[1]];
            if (!is_array($ret5934ad3e7dde4)) {
                throw new \InvalidArgumentException("Argument returned must be of the type array, " . gettype($ret5934ad3e7dde4) . " given");
            }
            return $ret5934ad3e7dde4;
    ...
    public function testFiles($test_file_list, $expected_file_path, $config_file_path = null)
    {
        ...
        $original_src = file_get_contents($expected_file_path);

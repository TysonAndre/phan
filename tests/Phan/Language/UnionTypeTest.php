...
class UnionTypeTest extends BaseTest
{
    ...
    protected function setUp()
    {
        ...
        $this->code_base = new CodeBase($internal_class_name_list, $internal_interface_name_list, $internal_trait_name_list, $internal_const_name_list, $internal_function_name_list);
    ...
    {
        $this->assertUnionTypeStringEqual('[1, "string"]', 'array');
    }
    public function testArrayEmpty()
    {
        $this->assertUnionTypeStringEqual('[]', 'array');
    }
    public function testInternalObject()
    {
        $this->assertUnionTypeStringEqual('new SplStack();', '\\ArrayAccess|\\Countable|\\Iterator|\\Serializable|\\SplDoublyLinkedList|\\SplStack|\\Traversable');
    }
    public function testGenericArrayType()
    {
        $type = GenericArrayType::fromElementType(GenericArrayType::fromElementType(IntType::instance(false), false), false);
     ...
     */
    private function assertUnionTypeStringEqual($code_stub, $type_name)
    {

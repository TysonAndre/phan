...
class AnalyzerTest extends BaseTest
{
    ...
    protected function setUp()
    {
        ...
        $this->code_base = $code_base = new CodeBase([], [], [], [], []);
    }
    ...
    {
        $context = $this->contextForCode("\n                namespace A;\n                Class B {}\n            ");
        self::assertTrue($this->code_base->hasClassWithFQSEN(FullyQualifiedClassName::fromFullyQualifiedString('\\A\\B')));
    }
     ...
     * bit of code.
     */
    private function contextForCode($code_stub)
    {
